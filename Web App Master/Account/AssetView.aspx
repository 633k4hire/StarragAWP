<%@ Page Title="Portal" Async="true" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AssetView.aspx.cs" Inherits="Web_App_Master.Account.AssetView" %>
<%@ MasterType VirtualPath="~/Site.Master" %>


<asp:Content ID="Portal" ContentPlaceHolderID="MainContent" runat="server">
...
<div class="awp-sub-side-stuck" id ="ColorCodesDiv" style="display:none">
        <div class="glyph-btn bg-sg-blue fg-white shadow-metro-black">Checked In</div>
        <div class="glyph-btn bg-sg-amber fg-white shadow-metro-black">Checked Out</div>
        <div class="glyph-btn bg-sg-red fg-white shadow-metro-black">Damaged</div>
        <div class="glyph-btn bg-sg-lime fg-white shadow-metro-black">Calibrated</div>
        <div class="glyph-btn bg-sg-violet fg-white shadow-metro-black">On Hold</div>
...
<%--                <li><a href="#" onclick="ChangeAssetView('lgtile'); ">large Tile</a></li>--%>
       ...
       <asp:LoginView ID="createLoginView" runat="server" >
			<RoleGroups>
				<asp:RoleGroup Roles="superadmin,Admins">
					<ContentTemplate>
						<ul class="nav navbar-nav navbar-right starrag-menu">
						   <li><a href="CreateAsset.aspx"><i class="fas fa-plus"></i><strong>Create</strong></a></li>
						</ul>
