...
public static class SQLfunc
{
    ...
    public static string _ConnectionString = @"Server=tcp:starragawp.database.windows.net,1433;Initial Catalog=AWP_CORE;Persist Security Info=False;User ID=mdcadmin;Password=Gh0stbust3r1;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;"; // @"Data Source=lastsoul.database.windows.net;Initial Catalog=db;Integrated Security=False;User ID=yuriebasuta;Password=********;Connect Timeout=60;Encrypt=False;TrustServerCertificate=True;ApplicationIntent=ReadWrite;MultiSubnetFailover=False";
