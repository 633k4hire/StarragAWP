                         ...
                         <div class="awp_box rounded bg-sg-title shadow">           
                            ...
                            <div class="awp_box_content bg-sg-box" style="text-align:left;" >   
                                ...
                                <h4 class="fg-white shadow-metro-black">
                                    ...
                                    <asp:RequiredFieldValidator ID="AnonValidator" CssClass="fg-red shadow-metro-black" Enabled="false" ErrorMessage="Email Required" ControlToValidate="AnonUserInput" runat="server" />
                                </h4>
                                <hr />
