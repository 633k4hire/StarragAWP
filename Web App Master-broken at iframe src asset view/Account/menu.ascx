...
<div class="app-bar">
                    ...
                    <ul class="app-bar-menu place-right hidden" data-flexdirection="reverse">
                        
                        
                        
                    </ul>
                <div class="clearfix" style="width: 0;"></div><nav class="app-bar-pullmenu hidden flexstyle-app-bar-menu" style="display: none;"><ul class="app-bar-pullmenubar hidden app-bar-menu"></ul><ul class="app-bar-pullmenubar app-bar-menu" style="display: block;"><li data-flexorderorigin="0" data-flexorder="1" class="app-bar-pullmenu-entry">
